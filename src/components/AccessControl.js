...
export default function AccessControl() {
  ...
  return (
    <div>
        <div className='m-8 mb-6 mt-0 rounded-[10px] p-6 w-[90%] max-w-[1350px] border border-[#707070]'>
            <h2 className='text-[#000000] text-[20px] font-[ClashDisplay-Bold] mb-4'>Team</h2>
            <p className='bg-[#EFEFF4] p-3 text-[#A859FC] w-full rounded-[5px]'>Add Member ⊕</p>

            {/* Scrollable table wrapper */}
            <div className="overflow-x-auto">
                <table className="min-w-[1350px] text-sm text-left text-[#000000]">
                <tbody>
