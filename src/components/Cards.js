...
export default function Cards() {
  ...
  return (
    <div className='p-8 py-6 flex flex-wrap gap-[20px]'>
      ...
      <div className='w-full 2xl:w-[22.5%] lg:w-[30%] bg-[#F9597C17] p-6 py-10 flex item-center rounded-[10] border border-[#F9597C]'>
        <div className='p-1 rounded-[50%] bg-[#FE487140] border border-[#F9597C] w-[60] h-[60] flex items-center justify-center'>
          <Image alt="aaft" src="/school.png" width={40} height={40} className="w-[40px] h-[40px]" />
          </div>
      ...
      <div className='w-full 2xl:w-[22.5%] lg:w-[30%] bg-[#F9597C17] p-6 py-10 flex item-center rounded-[10] border border-[#F9597C]'>
        <div className='p-1 rounded-[50%] bg-[#FE487140] border border-[#F9597C] w-[60] h-[60] flex items-center justify-center'>
          <Image alt="aaft" src="/ledger.png" width={40} height={40} className="w-[40px] h-[40px]" />
          </div>
      ...
      <div className='w-full 2xl:w-[22.5%] lg:w-[30%] bg-[#BE83FF17] p-6 py-10 flex item-center rounded-[10] border border-[#BE83FF]'>
        <div className='p-1 rounded-[50%] bg-[#BE83FF17] border border-[#BE83FF] w-[60] h-[60] flex items-center justify-center'>
          <Image alt="aaft" src="/manOffice.png" width={40} height={40} className="w-[40px] h-[40px]" />
          </div>
